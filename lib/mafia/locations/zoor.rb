...
module Game
  module Locations
    module Zoor
      Description={name:"کافه زور",details:"کافه روشنفکری با چاشنی بیگاری و دردسر",group: :zoor,timeout: 60, ticket: 10 ,mod: self, last_update: Time.now }
      # def self.visible; []; end
      Description[:details]="<img src='img/zoor.jpg' style='width:100px; margin:15px; position:relative; float:left;margin-top:0px;'></img>"+
                            Description[:details]
